...
// window.alert("iam viplove"); 
// let ans=window.confirm("are you sure to delet")
// console.log(ans)
// let name=window.prompt("did u like my website")
//     window.alert(name)
// }
// viplove(); 
...
// function start(){
//     let go=window.prompt("are you doing well")
//     window.alert(go)
// }
// function okk(){
//     // let show=prompt("my name is viplove")
//     // window.alert(show)
//     let greet=confirm("did u like my website")//ok or cancel
...
//     let ans=parseInt(prompt("entetr the price"))

//     let conans=confirm("do you have any discount coupon")
...
// let game=parseInt(prompt("guess the no between 1 to 20"))
...
//   }
  ...
  //   let ans = confirm(" hey do u wnat to delete this file")

  //   if(ans){
  //     alert("your file is deleteds")
  //   }
  //   else[
  ...
  //     for(let i=0;i<=50;i++){
  //       if(i%5===0){
  //         console.log(i+"it is divisible by 5")
  //       }
  //     }
